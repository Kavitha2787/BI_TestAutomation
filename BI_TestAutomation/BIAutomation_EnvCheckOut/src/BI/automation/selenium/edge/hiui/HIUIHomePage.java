...
package BI.automation.selenium.edge.hiui;
...
public class HIUIHomePage extends CommonPageClass{
	...
	public HIUIHomePage(){
		System.out.println("Im fine here HIUIHomePage start");
		driver=WebDriverStore.getWebDriverFromStore(PropertiesStore.getCurrentScreenshotFolder());
		System.out.println("Im fine here HIUIHomePage end"+driver.getTitle());
	...
	public void openHIUIHomePage(){
		try{
			...
			System.out.println("Open HIUI HomepageStep1"+driver.getTitle());
			...
			try{
				//Check sometimes mobile login appeared
				wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.id("txtUsername")));
				wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.id("txtPassword")));
				wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.id("btnSubmit")));
				touchscreen=true;
				StatusStore.updateStatus("openHIUIHomePage", "PASSED", "AS EXPECTED", "", "","");
				this.TakeScreenshot(driver);
			}catch(Exception e1){
	...
	public void logIn(String userid,String password){
		...
		try{
			if(!touchscreen){
				BILogger.writeInfoToLog(this.getClass(), "touchscreen disabled");
				//Wait untill the username and password field and login button is visible
				wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.id("ctlusernameText__")));
				wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.id("ctlpasswordText__")));
				wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.id("ctllogonBtnButton__")));
				...
				BILogger.writeInfoToLog(this.getClass(), "touchscreen enabled");
				//Click and type the Username
				wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.id("txtUsername")));
				wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.id("txtPassword")));
				wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.id("btnSubmit")));
